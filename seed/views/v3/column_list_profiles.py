...
from seed.utils.viewsets import SEEDOrgReadOnlyModelViewSet, SEEDOrgNoPatchModelViewSet


class ColumnListProfileSchema(AutoSchemaHelper):
    def __init__(self):
        super().__init__()
        ...
        self.manual_fields = {
            ...
            ('POST', 'create'): [self.body_field(False, 'description')],
        }


class ColumnListProfileViews(OrgValidateMixin, SEEDOrgNoPatchModelViewSet):
    """
    ...
    schema = ColumnListProfileSchema()
